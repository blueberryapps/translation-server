...
RSpec.describe LocalesController, type: :controller do
  ...
  describe 'GET #edit' do
    it 'assigns the requested locale as @locale' do
      locale = Locale.create! valid_attributes
      get :edit, params: { id: locale.to_param }
      expect(assigns(:locale)).to eq(locale)
    end
  end
  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new Locale' do
        expect {
          post :create, params: { project_id: project, locale: valid_attributes }
    ...
    context 'with invalid params' do
      it 'assigns a newly created but unsaved locale as @locale' do
        post :create, params: { project_id: project, locale: invalid_attributes }
        expect(assigns(:locale)).to be_a_new(Locale)
      end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested locale' do
        locale = Locale.create! valid_attributes
        put :update, params: { id: locale.to_param, locale: new_attributes }
        locale.reload
      ...
      it 'assigns the requested locale as @locale' do
        locale = Locale.create! valid_attributes
        put :update, params: { id: locale.to_param, locale: valid_attributes }
        expect(assigns(:locale)).to eq(locale)
      end
    ...
    context 'with invalid params' do
      it 'assigns the locale as @locale' do
        locale = Locale.create! valid_attributes
        put :update, params: { id: locale.to_param, locale: invalid_attributes }
        expect(assigns(:locale)).to eq(locale)
      end
